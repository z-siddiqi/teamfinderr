...
class SkillCategoryMixin(
    models.Model
):  # The type that the skill falls under -> e.g. python type is technical
...
class Skill(
    SkillCategoryMixin
):  # table to store a skill -> skill is mapped to users and projects -> skill has a name, a category
